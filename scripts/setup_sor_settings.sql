-- =====================================================================
-- One-time per-env setup for Sor cron jobs (daily-diff + watchdogs)
-- =====================================================================
--
-- Populates the public.sor_settings table (created by migration
...
INSERT INTO public.sor_settings (name, value, updated_at)
VALUES
  ('sor_sync_url',    'https://<PROJECT_REF>.supabase.co/functions/v1/sor-sync',          now()),
