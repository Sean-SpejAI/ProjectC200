...
// in the ImageRight environment our integration is connected to?
//
...
// different ImageRight environment than the one we connect to).
//
// Mirrors admin-inspect-imageright-file's auth: verify_jwt=false at the platform
...
// short-form key, NOT the legacy JWT in imageright_settings).
//
// Body (JSON):
