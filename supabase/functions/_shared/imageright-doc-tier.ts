// Processing tier for an ImageRight document, decided from its type code.
//
// ImageRight returns many small documents per claim. Low-value administrative
...
// Stored on claim_documents.imageright_processing_tier at pull time and read
// back by analyze-claim-document to branch the staged pipeline.

export type ProcessingTier = "full" | "light";

// ImageRight type codes (ObjType.Name) routed to the light tier.
