...
-- original watchdog only re-dispatched source='sor'. Broadening the
-- source filter to ('sor','manual') makes manual processing
...
-- 20260602010000_sor_settings_table.sql) — only the WHERE source filter
