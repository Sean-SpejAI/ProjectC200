...
-- client PDFs (some Sor bundles run that large) can be uploaded.
--
...
-- shows up as a storage-upload error in fetch-sor-document.
--
...
-- streaming the upload (fetch-sor-document) instead of buffering.
